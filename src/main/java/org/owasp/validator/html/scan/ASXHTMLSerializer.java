...
/**
 * This is an extension of the default XHTMLSerializer class that's had it's endElementIO() method
 * tweaked to serialize closing tags and self-closing tags the way we require.
 */
